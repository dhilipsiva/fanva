//! The English→Lojban system prompt. Extends the proven prompt shape with an
...
mod tests {
    ...
    /// otherwise the prompt would be teaching the model Lojban that our own
    /// firewall rejects. This also guards new examples.
    #[test]
